...
print("Installing...")
try:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/connect_4/archive/main.zip", tmp)
    file += "main"
except urllib.error.HTTPError:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/connect_4/archive/master.zip", tmp)
    file += "master"
